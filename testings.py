...
linecolor = 255, 0, 0
bgcolor = pygame.image.load('Images/auction bg.jpg')
while running:
    screen.blit(bgcolor,bgcolor.get_rect())
...
while True:
    if times>100:
        ...
        while times<=100:
            ...
            windowSurface.blit(pygame.transform.scale(picture, (960,640)), (0,0))
            times+=1
            pygame.display.flip()
            
    pygame.display.flip()'''

'''#downloaded game for referring to AI
